...
console.log('employees order by ID asc', employees.map(a => ({ ...a })).sort((l, r) => l.id - r.id));
console.log('employees order by ID desc', employees.map(a => ({ ...a })).sort((l, r) => r.id - l.id));
console.log('employees order by AGE asc', employees.map(a => ({ ...a })).sort((l, r) => l.age - r.age));

console.log('employees order by JD asc', employees.map(a => ({ ...a })).sort((l, r) => {
...
console.log('employees order by FN asc', employees.map(a => ({ ...a })).sort((l, r) => {
